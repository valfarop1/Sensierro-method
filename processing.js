...
function predictImage() {
    ...
    //console.log(`image cols: ${image.cols}, image rows: ${image.rows}`);
    ...
    // Testing only
    //const outuputCanvas = document.createElement('CANVAS');
    //cv.imshow(outuputCanvas,image);
    //document.body.appendChild(outuputCanvas);
